...
w, h = 400, 400  # Initial size of the screen in pixels.
        
img_o = function.run_op(position,radius,color,diffuse,specular_c,specular_k,L,color_light,ambient,O,Q,w,h)
img = run()
@pytest.mark.parametrize("test_input,reference",[(img_o, img)],)
